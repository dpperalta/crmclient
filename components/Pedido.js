...
const Pedido = ({ pedido }) => {
    ...
    // Mutation para cambiar el estado del pedio
    ...
    // Función para modificar el color del pedido de aceurdo al estado
    const clasePedido = () => {
